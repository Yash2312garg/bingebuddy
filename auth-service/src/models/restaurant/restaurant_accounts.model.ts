...
export const createNewRetaurantAccount = async(id: string, email:string|null, phone_number: number|null, reference_id: string|null,auth_status: string|null,):Promise<string|null>=>{
    try{
        const query = `INSERT INTO restaurant_accounts (id, email, phone_number,reference_id, auth_status) VALUES ($1, $2, $3, $4, $5) returning id`
        const values = [id,email,phone_number, reference_id,auth_status]
